...
def test_workflow_shortcuts_occupy_the_panel_header_row():
...
def test_shortcuts_open_templates_safely_and_support_full_customization():
    ...
    assert '<ShortcutGlyph icon={shortcut.icon} />' in shortcuts
    assert 'aria-label="Add shortcut"' in shortcuts

...
class PythonRoundTripTests(unittest.TestCase):
    def test_flat_export_is_runnable_and_importable(self):
        ...
        ast.parse(script)
        self.assertIn("# Generated by Blacknode from workflow: Python Round Trip", script)
    ...
    def test_live_stream_export_waits_for_ctrl_c_and_stops_runtime(self):
        ...
        self.assertIn("atexit.register(_stop_blacknode_runtime_services)", script)
        self.assertIn("meta.get('type') == 'MapEnvironment'", script)
        self.assertIn(

...
| Robotics and vision packages | ROS 2 runtime nodes, live camera streams, VLM-driven OpenCV tracking, local reasoning dashboards, and stop-all runtime controls through `blacknode-ros2` and `blacknode-vision`. | [Extension Packages](docs/packages.md) |

...
const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    description: 'Fetch a Wikipedia summary, summarize with NVIDIA NIM, write summary.txt, then read it back',
    color: '#0891b2',
    nodes: [
      { ref: 'model',    type: 'Model',     params: { value: 'nim:meta/llama-3.1-8b-instruct' },                                           pos: [60,  60] },
      { ref: 'system',   type: 'Text',      params: { value: 'You are a technical writer. Summarise the text in 3 bullet points.' },        pos: [60, 210] },
      { ref: 'url',      type: 'Text',      params: { value: 'https://en.wikipedia.org/w/api.php?action=query&prop=extracts&exintro=1&explaintext=1&titles=Houdini_(software)&format=json&formatversion=2&origin=*' }, pos: [60, 380] },
      { ref: 'path',     type: 'Text',      params: { value: 'summary.txt' },                                                               pos: [60, 550] },
      { ref: 'fetch',    type: 'HTTPGet',   params: {},                                                                                     pos: [360, 360] },
      { ref: 'agent',    type: 'LLMAgent',  params: {},                                                                                     pos: [650, 250] },
      { ref: 'write',    type: 'FileWrite', params: {},                                                                                     pos: [920, 310] },
      { ref: 'read',     type: 'FileRead',  params: {},                                                                                     pos: [920, 500] },
      { ref: 'out_path', type: 'Output',    params: {},                                                                                     pos: [1210, 260] },
      { ref: 'out_text', type: 'Output',    params: {},                                                                                     pos: [1210, 500] },
    ],
    edges: [
      { from: 'model',  fromPort: 'value', to: 'agent',    toPort: 'model' },
      { from: 'system', fromPort: 'value', to: 'agent',    toPort: 'system' },
      { from: 'url',    fromPort: 'value', to: 'fetch',    toPort: 'url' },
      { from: 'fetch',  fromPort: 'text',  to: 'agent',    toPort: 'prompt' },
      { from: 'path',   fromPort: 'value', to: 'write',    toPort: 'path' },
      { from: 'agent',  fromPort: 'text',  to: 'write',    toPort: 'text' },
      { from: 'write',  fromPort: 'path',  to: 'read',     toPort: 'path' },
      { from: 'write',  fromPort: 'path',  to: 'out_path', toPort: 'value' },
      { from: 'read',   fromPort: 'text',  to: 'out_text', toPort: 'value' },
    ],
  },
  {

...
through **Edit workflow**. **Shortcuts & pedals** can bind recording actions to
keyboard keys or compatible USB pedal buttons. Opening the app is passive: recording starts in

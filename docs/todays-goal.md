...
- [ ] Add a CLI runner: `blacknode validate workflow.json` and `blacknode run workflow.json --output result.json`.
- [ ] Add Python export: `blacknode export-python workflow.json > workflow.py`.
